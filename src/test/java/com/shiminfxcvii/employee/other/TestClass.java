...
import com.shiminfxcvii.employee.controller.SearchRecordController;
...
import static com.shiminfxcvii.employee.other.HttpStatusTest.BAD_REQUEST;
import static com.shiminfxcvii.employee.other.TestClass.Color.RED;
...
//        out.println(TestEnum.ZERO_INTEGER);
        ...
        out.println(com.shiminfxcvii.employee.util.Constants.DATE_TIME);
        out.println(com.shiminfxcvii.employee.util.Constants.DATE_TIME);
