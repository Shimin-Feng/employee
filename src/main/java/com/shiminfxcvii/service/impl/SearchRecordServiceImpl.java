...
import static com.shiminfxcvii.util.Constants.ALL;
import static com.shiminfxcvii.util.Constants.JSON;
...
public class SearchRecordServiceImpl implements SearchRecordService {
     ...
     * 并且在 {@link com.shiminfxcvii.advice.SpringControllerAdvice} 中可以很好的定位抛出异常的地方
