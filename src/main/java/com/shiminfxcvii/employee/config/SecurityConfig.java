...
//                        })
                        ...
                        .ignoringRequestMatchers("/login", "/logout", "/api/v1/businessManageOrganization/getBusinessManageAccountPage")
                        // 指定要使用的 SessionAuthenticationStrategy。 默认是 CsrfAuthenticationStrategy。
//                .sessionAuthenticationStrategy(new CsrfAuthenticationStrategy(new CookieCsrfTokenRepository()))
...
//                .permitAll()
                        ...
                        .deleteCookies("Idea-2a3d4c", "JSESSIONID", "XSRF-TOKEN")
...
//        http.userDetailsService(null);
        ...
        http.addFilterAfter(jwtOncePerRequestFilter, UsernamePasswordAuthenticationFilter.class);
